...
class PictureItemDecoration extends RecyclerView.ItemDecoration {
	...
	PictureItemDecoration(Context context) {
		...
		this.verticalSpace = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 1F, displayMetrics);
		this.horizontalSpace = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 0.5F, displayMetrics);
	}
