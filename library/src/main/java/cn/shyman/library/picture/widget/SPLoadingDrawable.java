 ...
 */
public class SPLoadingDrawable extends Drawable implements Animatable {
	...
	private static final float CENTER_RADIUS_LARGE = 18.5f;
	...
	public SPLoadingDrawable(Context context, View parent) {
		mParent = parent;
